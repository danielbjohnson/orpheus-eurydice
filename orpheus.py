...
def make_choice():
    userChoice = input("Your choice, A or B: ")
    if userChoice == "A" or userChoice == "a":
        return "A"
    elif userChoice == "B" or userChoice == "b":
        return "B"
    else:
        prints("Orpheus was bound by the will of gods, and you are bound by the rules of this game. Enter A or B. ")
        return make_choice()
...
input("an Orpheus and Eurydice game \n\n[press Enter to begin] ")
print()

print("Press A for text to appear at reading speed, or B for super speed.")
if make_choice() == "A":
    sleep_speed = 0.03
else:
    sleep_speed = 0.0001
